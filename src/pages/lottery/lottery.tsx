    ...
    return (
      <View className='lotteryBox'>
        <View className='lotteryBoxs'>
          ...
          <View data-id='1' className={ current % 8 === 1 ? 'active' : 'item'  }>
          ...
          <View data-id='2' className={ current % 8 === 2 ? 'active' : 'item'  }>
          ...
          <View data-id='7' className={ current % 8 === 7 ? 'active' : 'item'  }>
          ...
          <View data-id='3' className={ current % 8 === 3 ? 'active' : 'item'  }>
          ...
          <View data-id='6' className={ current % 8 === 6 ? 'active' : 'item'  }>
          ...
          <View data-id='5' className={ current % 8 === 5 ? 'active' : 'item'  }>
          ...
          <View data-id='4' className={ current % 8 === 4 ? 'active' : 'item'  }>
